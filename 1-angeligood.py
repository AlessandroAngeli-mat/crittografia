...
class CryptoError(Exception):
 '''An error has occurred during the encryption/decryption process'''
class MenuError(Exception):
 '''An error has occurred during the selection'''
...
def encrypt_auth(file_path, key_path):
 ...
 with open(file_path, "rb") as in_file:
    ...
    plaintext = in_file.read()
    # add padding if needed
    laintext = adjust_plaintext_padding(plaintext, block_size)
